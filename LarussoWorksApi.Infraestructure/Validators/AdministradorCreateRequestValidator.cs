...
{
    public class AdministradorCreateRequestValidator : AbstractValidator<AdministradorCreateRequest>
    {
        public AdministradorCreateRequestValidator()
        {
            ...
            */
            ...
            RuleFor(x => x.CorreoAdmin).NotEmpty().WithMessage("El Correo, no debe estar vacio")
                .EmailAddress().WithMessage("Se requiere una dirección de correo electronico válido (correo@mail.com)");

            RuleFor(x => x.ContrasenaAdmin)
